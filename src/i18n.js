...
const resources = {
  pt: {
    translation: {
      ...
      errorRateInfo: "Taxa de erro é um valor percentual que determina a variação possível no tempo total de execução dessa atividade.",
      ...
      fillGenerateOnly: "Preencha somente se quiser Gerar Dados. Desnecessário para download de arquivo.",
      type: "Tipo",
      ...
      howToUsePurpose: "Para que serve o INTERFACE HESTIA?",
      howToUsePurposeDesc: "A Interface HESTIA foi desenvolvida com o objetivo de facilitar a criação de casos de teste para o sistema original HESTIA. Devido ao grande volume de dados envolvidos, esse processo tornou-se desafiador. A interface visa simplificar e agilizar essa etapa, permitindo a geração de exemplos representativos de maneira mais eficiente e acessível.",
      howToUseHowWorks: "Como funciona?",
      howToUseHowWorksDesc: "O projeto permite que o usuário crie PARÂMETROS e PRESETS para a criação de rotinas. Evitando assim retrabalho na criação dos arquivos JSON. Após criar parâmetros e associá-los à um preset, basta criar rotinas para cada pessoa que pertence àquele preset.",
      howToUseParamsPresets: "Parâmetros e Presets",
      howToUseParams: "Parâmetros",
      howToUseParamsDesc: "Parâmetros são objetos que podem ser criados pelo usuário e associados em diversos presets, além de auxiliarem na criação de rotinas. Os parâmetros são a base de um preset, e por conta da possibilidade de serem reutilizados em vários presets diferentes, tornam o processo de criação menos manual e mais ágil.",
      howToUseParamsPeople: "Pessoas: Pessoas que vivem em um espaço. Podem ser reutilizadas em vários presets diferentes.",
      howToUseParamsActivities: "Atividades: Atividades que as pessoas realizam em um espaço. Podem ser reutilizadas em vários presets diferentes, e ocorrerem várias vezes durante uma rotina.",
      howToUseParamsRooms: "Cômodos: Cômodos dentro de um espaço. Podem ser reutilizados em vários presets diferentes.",
      howToUseParamsActuators: "Atuadores: Atuadores que pertencem à um cômodo. Podem ser reutilizados em vários cômodos, e instanciados mais de uma vez por cômodo.",
      howToUseParamsActivityPreset: "Atividade com Preset: Atividades associadas a um preset. Aqui é possível criar atividades secundárias e a probabilidade de ocorrerem no meio de uma atividade principal. Além disso, também é possível selecionar atuadores que são modificados durante a atividade.",
      howToUsePresets: "Presets",
      howToUsePresetsDesc: "Os Presets são a maneira em que o sistema cria \"espaços\" em que uma rotina se passa. Dentro de um preset é possível criar associar instâncias de parâmetros que pertencem àquele espaço.",
      howToUseStepByStep: "Passo a Passo: Como criar uma rotina",
      howToUseStep1: "Passo 1: Criação de Pessoas",
      howToUseStep1Desc: "Em Gerenciamento de Parâmetros, crie pessoas que serão utilizadas como parâmetros em vários presets.",
      howToUseStep2: "Passo 2: Criação de Atividades",
      howToUseStep2Desc: "Em Gerenciamento de Parâmetros, crie atividades que serão utilizadas na criação de várias atividades com presets.",
      howToUseStep3: "Passo 3: Criação de Cômodos",
      howToUseStep3Desc: "Em Gerenciamento de Parâmetros, crie cômodos que serão utilizadas como parâmetros na criação de vários presets.",
      howToUseStep4: "Passo 4: Leitura de Atuadores",
      howToUseStep4Desc: "Atuadores são parâmetros fixos no código original do HESTIA, portanto não é possível criá-los como um parâmetro. Entretanto, deve-se usar os atuadores como parâmetros que pertencem aos cômodos dentro de um preset.",
      howToUseStep5: "Passo 5: Criação de Preset",
      howToUseStep5Desc: "Após ter criado os parâmetros necessários, deve-se criar o preset. Selecione o nome, os cômodos que pertencem ao preset, os atuadores que podem ser utilizados em um cômodo e o grafo de distância entre os cômodos.",
      howToUseStep6: "Passo 6: Criação de Atividades com Presets",
      howToUseStep6Desc: "Depois de ter criado um preset, crie atividades relacionadas apenas àquele preset. Esta associação é necessária pois permite a utilização de propriedades pertencentes àquele preset, como cômodo e atuadores pertencentes aos cômodos.",
      howToUseStep7: "Passo 7: Criação de Rotinas",
      howToUseStep7Desc: "Após ter criado o preset e as atividades relacionadas àquele preset, vá em criar rotinas, adicione uma ou mais pessoas e construa a rotina da pessoa. Perceba que cada rotina deve completar 24h diárias."
      },
      },
      en: {
        translation: {
      ...
      errorRateInfo: "Error rate is a percentage value that determines the possible variation in the total execution time of this activity.",
      ...
      fillGenerateOnly: "Fill in only if you want to Generate Data. Not necessary for file download.",
      type: "Type",
      days: "Number of Days",
      simple: "Simple",
      complete: "Complete",
      ...
      // How To Use - Accordion
      howToUsePurpose: "What is the HESTIA INTERFACE for?",
      howToUsePurposeDesc: "The HESTIA Interface was developed to facilitate the creation of test cases for the original HESTIA system. Due to the large volume of data involved, this process became challenging. The interface aims to simplify and speed up this step, allowing the generation of representative examples more efficiently and accessibly.",
      howToUseHowWorks: "How does it work?",
      howToUseHowWorksDesc: "The project allows the user to create PARAMETERS and PRESETS for routine creation, thus avoiding rework in creating JSON files. After creating parameters and associating them with a preset, just create routines for each person belonging to that preset.",
      howToUseParamsPresets: "Parameters and Presets",
      howToUseParams: "Parameters",
      howToUseParamsDesc: "Parameters are objects that can be created by the user and associated with several presets, in addition to assisting in routine creation. Parameters are the basis of a preset, and because they can be reused in several different presets, they make the creation process less manual and more agile.",
      howToUseParamsPeople: "People: People who live in a space. They can be reused in several different presets.",
      howToUseParamsActivities: "Activities: Activities that people perform in a space. They can be reused in several different presets and occur several times during a routine.",
      howToUseParamsRooms: "Rooms: Rooms within a space. They can be reused in several different presets.",
      howToUseParamsActuators: "Actuators: Actuators that belong to a room. They can be reused in several rooms and instantiated more than once per room.",
      howToUseParamsActivityPreset: "Activity with Preset: Activities associated with a preset. Here you can create secondary activities and the probability of them occurring during a main activity. In addition, it is also possible to select actuators that are modified during the activity.",
      howToUsePresets: "Presets",
      howToUsePresetsDesc: "Presets are the way the system creates \"spaces\" in which a routine takes place. Within a preset, you can create and associate instances of parameters that belong to that space.",
      howToUseStepByStep: "Step by Step: How to create a routine",
      howToUseStep1: "Step 1: Creating People",
      howToUseStep1Desc: "In Parameter Management, create people who will be used as parameters in several presets.",
      howToUseStep2: "Step 2: Creating Activities",
      howToUseStep2Desc: "In Parameter Management, create activities that will be used in the creation of several activities with presets.",
      howToUseStep3: "Step 3: Creating Rooms",
      howToUseStep3Desc: "In Parameter Management, create rooms that will be used as parameters in the creation of several presets.",
      howToUseStep4: "Step 4: Reading Actuators",
      howToUseStep4Desc: "Actuators are fixed parameters in the original HESTIA code, so it is not possible to create them as a parameter. However, actuators should be used as parameters that belong to rooms within a preset.",
      howToUseStep5: "Step 5: Creating a Preset",
      howToUseStep5Desc: "After creating the necessary parameters, you must create the preset. Select the name, the rooms that belong to the preset, the actuators that can be used in a room, and the distance graph between the rooms.",
